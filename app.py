...
class GateTrader:
    ...
    def calculate_signals(self, df: pd.DataFrame) -> tuple:
        try:
            ...
            if current_cross and prev_cross:
                current_signal = 'BUY'
                print(f"EMA Crossover - EMA10:{current_candle['EMA10']:.8f} EMA30:{current_candle['EMA30']:.8f}")
    ...
    def check_sell_signal(self, currency: str) -> tuple[bool, float]:
        try:
            ...
            if ema_cross_down:
                print(f"Sell signal for {currency}: EMA5 crossed below EMA10 - Selling entire position")
